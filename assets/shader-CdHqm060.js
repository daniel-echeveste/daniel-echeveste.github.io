import{r as s,k as c,a as o,T as g,S as x,D as U,o as d,p as i,j as n,V as b}from"./index-D-NK-nyJ.js";var l=`varying vec2 vUv;
...
}`;function p(){const e=s.useRef(),t=c({pattern:{value:23,min:5,max:50,step:1}}),v=()=>{console.log("pepe")};o((m,f)=>{}),new g().load("/textures/can-flag.jpg");const r=new x({vertexShader:l,fragmentShader:y,side:U,uniforms:{uPattern:{value:t.pattern}}}),a=new d(1);return i({shaderMaterial:r}),n.jsx(n.Fragment,{children:n.jsx("mesh",{geometry:a,material:r,useRef:e,scale:new b(2,2,2),onClick:v,position:[0,0,-1]})})}export{p as default};
//# sourceMappingURL=shader-CdHqm060.js.map
