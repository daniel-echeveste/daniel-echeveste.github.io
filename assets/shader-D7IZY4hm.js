import{b as B,U as a,o as T,X as N,L as D,Q as U,Y as E,e as G,j as W}from"./index-D8glOjKT.js";import"./models-Bga9fsqJ.js";import{C as M}from"./vanilla-307d3a93.esm-Bc2fuMDi.js";function L(r,e=1e-4){e=Math.max(e,Number.EPSILON);const c={},x=r.getIndex(),w=r.getAttribute("position"),v=x?x.count:w.count;let u=0;const f=Object.keys(r.attributes),z={},l={},S=[],q=["getX","getY","getZ","getW"],j=["setX","setY","setZ","setW"];for(let o=0,s=f.length;o<s;o++){const t=f[o],n=r.attributes[t];z[t]=new n.constructor(new n.array.constructor(n.count*n.itemSize),n.itemSize,n.normalized);const d=r.morphAttributes[t];d&&(l[t]||(l[t]=[]),d.forEach((i,m)=>{const p=new i.array.constructor(i.count*i.itemSize);l[t][m]=new i.constructor(p,i.itemSize,i.normalized)}))}const I=e*.5,_=Math.log10(1/e),F=Math.pow(10,_),X=I*F;for(let o=0;o<v;o++){const s=x?x.getX(o):o;let t="";for(let n=0,d=f.length;n<d;n++){const i=f[n],m=r.getAttribute(i),p=m.itemSize;for(let h=0;h<p;h++)t+=`${~~(m[q[h]](s)*F+X)},`}if(t in c)S.push(c[t]);else{for(let n=0,d=f.length;n<d;n++){const i=f[n],m=r.getAttribute(i),p=r.morphAttributes[i],h=m.itemSize,Y=z[i],k=l[i];for(let y=0;y<h;y++){const P=q[y],C=j[y];if(Y[C](u,m[P](s)),p)for(let g=0,Z=p.length;g<Z;g++)k[g][C](u,p[g][P](s))}}c[t]=u,S.push(u),u++}}const b=r.clone();for(const o in r.attributes){const s=z[o];if(b.setAttribute(o,new s.constructor(s.array.slice(0,u*s.itemSize),s.itemSize,s.normalized)),o in l)for(let t=0;t<l[o].length;t++){const n=l[o][t];b.morphAttributes[o][t]=new n.constructor(n.array.slice(0,u*n.itemSize),n.itemSize,n.normalized)}}return b.setIndex(S),b}var A=`uniform float uTime;\r
