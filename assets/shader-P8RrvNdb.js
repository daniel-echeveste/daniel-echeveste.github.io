import{r as c,k as u,l as f,T as v,R as a,S as d,U as r,C as g,A as p,a as h,j as n}from"./index-BBphsDQ8.js";var x=`varying vec2 vUv;\r
...
}`;function C(){const o=c.useRef(),l=u({uColor:"#ff0000"});let i=0;const s=new f,e=new v().load("./textures/perlin.png");e.wrapS=a,e.wrapT=a;const t=new d({transparent:!0,vertexShader:x,fragmentShader:T,wireframe:!1,uniforms:{uTime:new r(0),uPerlinTexture:new r(e),uColor:new r(new g(l.uColor))},depthWrite:!1,blending:p});return h((m,w)=>{i=m.clock.elapsedTime,t.uniforms.uTime.value=i,o.current.rotation.y+=.005}),n.jsxs(n.Fragment,{children:[n.jsx("mesh",{geometry:s,material:t,ref:o}),n.jsx("ambientLight",{intensity:.5}),n.jsx("directionalLight",{castShadow:!0,position:[4,2,-2.25],intensity:10})]})}export{C as default};
//# sourceMappingURL=shader-P8RrvNdb.js.map
