import{c as p,w as c,T as u,r as n,x as d,u as x,e as h,j as r,E as j,h as y}from"./index-De2ib58j.js";const m=t=>t===Object(t)&&!Array.isArray(t)&&typeof t!="function";function i(t,a){const s=p(o=>o.gl),e=c(u,m(t)?Object.values(t):t);return n.useLayoutEffect(()=>{a?.(e)},[a]),n.useEffect(()=>{if("initTexture"in s){let o=[];Array.isArray(e)?o=e:e instanceof d?o=[e]:m(e)&&(o=Object.values(e)),o.forEach(l=>{l instanceof d&&s.initTexture(l)})}},[s,e]),n.useMemo(()=>{if(m(t)){const o={};let l=0;for(const g in t)o[g]=e[l++];return o}else return e},[t,e])}i.preload=t=>c.preload(u,t);i.clear=t=>c.clear(u,t);function S(t){const a=x("models/LeePerrySmith/LeePerrySmith.glb");console.log("modelo"),console.log(a),a.materials["Material.002"].map=i("models/LeePerrySmith/color.jpg"),a.materials["Material.002"].normal=i("models/LeePerrySmith/normal.jpg"),a.materials["Material.002"].normalMap=i("models/LeePerrySmith/normal.jpg");const s={uTime:{value:0}};return h((e,f)=>{s.uTime.value=e.clock.elapsedTime}),a.materials["Material.002"].onBeforeCompile=e=>{console.log(e.vertexShader),e.uniforms.uTime=s.uTime,e.vertexShader=e.vertexShader.replace("#include <common>",`
            #include <common>
...
//# sourceMappingURL=shader-C2yWN3zz.js.map
